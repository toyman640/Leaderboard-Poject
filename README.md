...
# :book: Leaderboard project <a name="about-project"></a>

**Leaderboard project** is a  project built with HTML, CSS AND JAVASCRIPT.
...
```
git clone https://github.com/toyman640/Leaderboard-Poject.git
```

- Navigate to the location of the folder in your machine:

**``you@your-Pc-name:~$ cd TLeaderboard-Poject``**
